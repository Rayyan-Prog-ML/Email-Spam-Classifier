...
Original file is located at
    https://colab.research.google.com/drive/1nZUemh2xZ-S6xLZLlTfyYauZHhsZL30m
"""

# prompt: i want to import below libraries so install right libraries for it liek nltk
...
# prompt: make a requirements.txt file and include all with versions

!pip freeze > requirements.txt

# prompt: make a requrement.txt file template and add versions
